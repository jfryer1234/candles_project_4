    ...
    return (
      <div className="render-div">
        <div className="block-div">
          ...
          {this.props.candleData.scent_2 === "no_scent" ? <h4>Scent: {this.state.scent[this.props.candleData.scent_1]}</h4> : <h4>Scents: {this.state.scent[this.props.candleData.scent_1]} & {this.state.scent[this.props.candleData.scent_2]}</h4>}
